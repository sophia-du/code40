...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	KEYMAP(
		...
		KC_LCTL, KC_LGUI, KC_LALT, KC_CAPS, TT(1), KC_SPC,        MO(2),   KC_SLSH, KC_LEFT, KC_DOWN, KC_RGHT),
	...
	KEYMAP(
		...
		KC_TRNS, KC_F3,   KC_F6,   KC_F9,   KC_F12, KC_F15,  KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_PGUP, KC_PSCR, 
		KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, RESET,  KC_TRNS,          KC_TRNS, KC_TRNS, KC_HOME, KC_PGDN, KC_END),
